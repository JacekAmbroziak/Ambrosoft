 ...
 * returns the total node of components.
 * <p>
 ...
 * <p><li><em>count</em>() returns the node of components.
 * </ul>
 * <p>
...
public class WeightedQuickUnionUF {
    ...
    private int[] size;     // size[i] = node of sites in subtree rooted at i
    private int count;      // node of components
    ...
    /**
     * Returns the node of components.
     *
     * @return the node of components (between <tt>1</tt> and <tt>N</tt>)
     */
    public int count() {
        return count;
    }
