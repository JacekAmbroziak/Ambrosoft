...
public interface Channel<E> extends Puttable<E>, Takable<E> {
     ...
     */
    public boolean offer(E item, long msecs) throws InterruptedException;
    ...
    public E poll(long msecs) throws InterruptedException;
